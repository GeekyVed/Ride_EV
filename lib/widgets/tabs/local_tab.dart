...
class LocalTripTab extends StatefulWidget {
  LocalTripTab({super.key});

  @override
  State<LocalTripTab> createState() => _LocalTripTabState();
}

class _LocalTripTabState extends State<LocalTripTab> {
